...
constexpr float STARTUP_SCENE_DURATION = 0.1f;                              // 启动场景加载时间（TODO: 节省调试时间）
...
constexpr int BATTLE_SCENE_RETURN_MENU_OFFSET_X = 515;                      // 对战场景返回菜单按钮位置 X 偏移量
constexpr int BATTLE_SCENE_RETURN_MENU_OFFSET_Y = -305;                     // 对战场景返回菜单按钮位置 Y 偏移量
...
constexpr int CHAMPION_NAME_LABEL_START_X = 182;                            // 战斗英雄名称标签位置 X 坐标
...
constexpr int LEVEL_LABEL_START_X = 254;                                    // 等级标签位置 X 坐标
...
const ChampionAttributes CHAMPION_17_ATTR = { // 金克斯（一星）
    Champion17, "金克斯", "../Resources/Champions/Champion17.png", 2, 1, 150, 30, 200, 1, 0.5f, 1.5f, 0.7f
};
const ChampionAttributes CHAMPION_18_ATTR = { // 金克斯（二星）
    Champion18, "金克斯", "../Resources/Champions/Champion18.png", 2, 2, 200, 35, 200, 2, 0.4f, 1.7f, 0.8f
};
