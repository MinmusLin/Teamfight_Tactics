...
const ChampionAttributes CHAMPION_1_ATTR = { // 劫（一星）
    Champion1, "劫", "../Resources/Champions/Champion1.png", 1, 1, 500, 0, 50, 200, 1, 0.75f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_2_ATTR = { // 劫（二星）
    Champion2, "劫", "../Resources/Champions/Champion2.png", 3, 2, 900, 0, 75, 200, 1, 0.75f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_3_ATTR = { // 永恩（一星）
    Champion3, "永恩", "../Resources/Champions/Champion3.png", 1, 1, 550, 0, 45, 200, 1, 1.0f, 1.0f, 1.2f
};
const ChampionAttributes CHAMPION_4_ATTR = { // 永恩（二星）
    Champion4, "永恩", "../Resources/Champions/Champion4.png", 3, 2, 990, 0, 68, 200, 1, 1.0f, 1.0f, 1.2f
};
const ChampionAttributes CHAMPION_5_ATTR = { // 奥拉夫（一星）
    Champion5, "奥拉夫", "../Resources/Champions/Champion5.png", 1, 1, 700, 0, 55, 200, 1, 0.6f, 1.0f, 1.4f
};
const ChampionAttributes CHAMPION_6_ATTR = { // 奥拉夫（二星）
    Champion6, "奥拉夫", "../Resources/Champions/Champion6.png", 3, 2, 1260, 0, 83, 200, 1, 0.6f, 1.0f, 1.4f
};
const ChampionAttributes CHAMPION_7_ATTR = { // 潘森（一星）
    Champion7, "潘森", "../Resources/Champions/Champion7.png", 1, 1, 700, 0, 70, 200, 1, 0.5f, 1.0f, 1.2f
};
const ChampionAttributes CHAMPION_8_ATTR = { // 潘森（二星）
    Champion8, "潘森", "../Resources/Champions/Champion8.png", 3, 2, 1260, 0, 105, 200, 1, 0.5f, 1.0f, 1.2f
};
const ChampionAttributes CHAMPION_9_ATTR = { // 伊芙琳（一星）
    Champion9, "伊芙琳", "../Resources/Champions/Champion9.png", 1, 1, 650, 0, 55, 200, 1, 0.55f, 1.0f, 1.3f
};
const ChampionAttributes CHAMPION_10_ATTR = { // 伊芙琳（二星）
    Champion10, "伊芙琳", "../Resources/Champions/Champion10.png", 3, 2, 1170, 0, 83, 200, 1, 0.55f, 1.0f, 1.3f
};
const ChampionAttributes CHAMPION_11_ATTR = { // 库奇（一星）
    Champion11, "库奇", "../Resources/Champions/Champion11.png", 2, 1, 500, 0, 50, 200, 3, 0.7f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_12_ATTR = { // 库奇（二星）
    Champion12, "库奇", "../Resources/Champions/Champion12.png", 6, 2, 900, 0, 75, 200, 3, 0.7f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_13_ATTR = { // 塔里克（一星）
    Champion13, "塔里克", "../Resources/Champions/Champion13.png", 2, 1, 750, 0, 60, 200, 1, 0.65f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_14_ATTR = { // 塔里克（二星）
    Champion14, "塔里克", "../Resources/Champions/Champion14.png", 6, 2, 1350, 0, 90, 200, 1, 0.65f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_15_ATTR = { // 亚索（一星）
    Champion15, "亚索", "../Resources/Champions/Champion15.png", 2, 1, 700, 0, 50, 200, 1, 0.75f, 1.0f, 1.1f
};
const ChampionAttributes CHAMPION_16_ATTR = { // 亚索（二星）
    Champion16, "亚索", "../Resources/Champions/Champion16.png", 6, 2, 1260, 0, 75, 200, 1, 0.75f, 1.0f, 1.1f
};
const ChampionAttributes CHAMPION_17_ATTR = { // 金克丝（一星）
    Champion17, "金克丝", "../Resources/Champions/Champion17.png", 2, 1, 600, 0, 65, 200, 5, 0.8f, 1.0f, 0.9f
};
const ChampionAttributes CHAMPION_18_ATTR = { // 金克丝（二星）
    Champion18, "金克丝", "../Resources/Champions/Champion18.png", 6, 2, 1080, 0, 98, 200, 5, 0.8f, 1.0f, 0.9f
};
const ChampionAttributes CHAMPION_19_ATTR = { // 塔姆（一星）
    Champion19, "塔姆", "../Resources/Champions/Champion19.png", 3, 1, 700, 0, 55, 200, 1, 0.6f, 1.0f, 1.6f
};
const ChampionAttributes CHAMPION_20_ATTR = { // 塔姆（二星）
    Champion20, "塔姆", "../Resources/Champions/Champion20.png", 9, 2, 1260, 0, 83, 200, 1, 0.6f, 1.0f, 1.6f
};
const ChampionAttributes CHAMPION_21_ATTR = { // 蔚（一星）
    Champion21, "蔚", "../Resources/Champions/Champion21.png", 3, 1, 800, 0, 60, 200, 1, 0.65f, 1.0f, 1.55f
};
const ChampionAttributes CHAMPION_22_ATTR = { // 蔚（二星）
    Champion22, "蔚", "../Resources/Champions/Champion22.png", 9, 2, 1440, 0, 90, 200, 1, 0.65f, 1.0f, 1.55f
};
const ChampionAttributes CHAMPION_23_ATTR = { // 阿木木（一星）
    Champion23, "阿木木", "../Resources/Champions/Champion23.png", 3, 1, 800, 0, 60, 200, 1, 0.7f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_24_ATTR = { // 阿木木（二星）
    Champion24, "阿木木", "../Resources/Champions/Champion24.png", 9, 2, 1440, 0, 90, 200, 1, 0.7f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_25_ATTR = { // 奎桑提（一星）
    Champion25, "奎桑提", "../Resources/Champions/Champion25.png", 4, 1, 950, 0, 80, 200, 1, 0.85f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_26_ATTR = { // 奎桑提（二星）
    Champion26, "奎桑提", "../Resources/Champions/Champion26.png", 12, 2, 1710, 0, 120, 200, 1, 0.85f, 1.0f, 1.5f
};
const ChampionAttributes CHAMPION_27_ATTR = { // 卡尔萨斯（一星）
    Champion27, "卡尔萨斯", "../Resources/Champions/Champion27.png", 4, 1, 600, 0, 100, 200, 5, 0.85f, 1.0f, 0.9f
};
const ChampionAttributes CHAMPION_28_ATTR = { // 卡尔萨斯（二星）
    Champion28, "卡尔萨斯", "../Resources/Champions/Champion28.png", 12, 2, 1080, 0, 140, 200, 5, 0.9f, 1.0f, 0.9f
};
const ChampionAttributes CHAMPION_29_ATTR = { // 卡莎（一星）
    Champion29, "卡莎", "../Resources/Champions/Champion29.png", 5, 1, 800, 0, 100, 200, 5, 0.9f, 1.0f, 0.9f
};
const ChampionAttributes CHAMPION_30_ATTR = { // 卡莎（二星）
    Champion30, "卡莎", "../Resources/Champions/Champion30.png", 15, 2, 1440, 0, 140, 200, 5, 0.9f, 1.0f, 0.9f
};
