...
constexpr int SETTINGS_SCENE_EASY_CHECKBOX_OFFSET_X = -290;                 // 设置场景难度复选框与标签位置 X 偏移量
constexpr int SETTINGS_SCENE_NORMAL_CHECKBOX_OFFSET_X = -150;               // 设置场景难度复选框与标签位置 X 偏移量
constexpr int SETTINGS_SCENE_DIFFICULT_CHECKBOX_OFFSET_X = -10;             // 设置场景难度复选框与标签位置 X 偏移量
