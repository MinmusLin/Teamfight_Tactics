...
// 选择小小英雄场景设置
constexpr int MAX_LITTLE_CHAMPION_COUNT = 8;                                      // 小小英雄最大数量
constexpr int SELECTION_SCENE_LITTLE_CHAMPION_BUTTON_OFFSET_X = -450;          // 选择场景小小英雄按钮位置 X 偏移量
constexpr int SELECTION_SCENE_LITTLE_CHAMPION_BUTTON_OFFSET_Y = -200;          // 选择场景小小英雄按钮位置 Y 偏移量
constexpr int SELECTION_SCENE_LITTLE_CHAMPION_BUTTON_DELTA_X = 300;           // 选择场景小小英雄按钮位置 X 差分量
constexpr int SELECTION_SCENE_LITTLE_CHAMPION_BUTTON_DELTA_Y = 250;           // 选择场景小小英雄按钮位置 Y 差分量
...
constexpr float LITTLE_CHAMPION_PARTICLE_SCALE = 0.5f;                      // 小小英雄粒子效果缩放比例
constexpr float LITTLE_CHAMPION_PARTICLE_LIFE = 0.75f;                      // 小小英雄粒子效果生命周期
constexpr float WEAPON_ANIMATION_ROTATION_DURATION = 0.15f;                 // 对战场景武器动画旋转时间
constexpr float BATTLE_SCENE_LOADINGBAR_DURATION = 10.0f;                   // 对战场景准备时间(TODO)
