...
const ChampionAttributes CHAMPION_1_ATTR = { // 劫（一星）
    Champion1, "劫", "../Resources/Champions/Champion1.png", 1, 1, 500, 0, 50, 200, 1, 0.75f, 1.0f, 1.0f, NoBond
};
const ChampionAttributes CHAMPION_2_ATTR = { // 劫（二星）
    Champion2, "劫", "../Resources/Champions/Champion2.png", 3, 2, 900, 0, 75, 200, 1, 0.75f, 1.0f, 1.0f, NoBond
};
...
const ChampionAttributes CHAMPION_13_ATTR = { // 塔里克（一星）
    Champion13, "塔里克", "../Resources/Champions/Champion13.png", 2, 1, 750, 0, 60, 200, 1, 0.65f, 1.0f, 1.5f, NoBond
};
const ChampionAttributes CHAMPION_14_ATTR = { // 塔里克（二星）
    Champion14, "塔里克", "../Resources/Champions/Champion14.png", 6, 2, 1350, 0, 90, 200, 1, 0.65f, 1.0f, 1.5f, NoBond
};
...
const ChampionAttributes CHAMPION_19_ATTR = { // 塔姆（一星）
    Champion19, "塔姆", "../Resources/Champions/Champion19.png", 3, 1, 700, 0, 55, 200, 1, 0.6f, 1.0f, 1.6f, NoBond
};
const ChampionAttributes CHAMPION_20_ATTR = { // 塔姆（二星）
    Champion20, "塔姆", "../Resources/Champions/Champion20.png", 9, 2, 1260, 0, 83, 200, 1, 0.6f, 1.0f, 1.6f, NoBond
};
const ChampionAttributes CHAMPION_21_ATTR = { // 蔚（一星）
    Champion21, "蔚", "../Resources/Champions/Champion21.png", 3, 1, 800, 0, 60, 200, 1, 0.65f, 1.0f, 1.55f, NoBond
};
const ChampionAttributes CHAMPION_22_ATTR = { // 蔚（二星）
    Champion22, "蔚", "../Resources/Champions/Champion22.png", 9, 2, 1440, 0, 90, 200, 1, 0.65f, 1.0f, 1.55f, NoBond
};
...
const ChampionAttributes CHAMPION_25_ATTR = { // 奎桑提（一星）
    Champion25, "奎桑提", "../Resources/Champions/Champion25.png", 4, 1, 950, 0, 80, 200, 1, 0.85f, 1.0f, 1.5f, NoBond
};
const ChampionAttributes CHAMPION_26_ATTR = { // 奎桑提（二星）
    Champion26, "奎桑提", "../Resources/Champions/Champion26.png", 12, 2, 1710, 0, 120, 200, 1, 0.85f, 1.0f, 1.5f, NoBond
};
