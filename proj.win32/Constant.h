...
constexpr int CHAMPION_HEALTHBAR_VERTICAL_INTERVAL = 30;                    // 对战场景生命条垂直间距
...
constexpr int INITIAL_GOLD_COIN = 9914;                                       // 初始金币数量
...
const ChampionAttributes CHAMPION_3_ATTR = { // 永恩（一星）
    Champion3, "永恩", "../Resources/Champions/Champion3.png", 1, 1, 200, 0, 25, 200, 1, 0.8f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_4_ATTR = { // 永恩（二星）
    Champion4, "永恩", "../Resources/Champions/Champion4.png", 3, 2, 250, 0, 30, 200, 1, 0.7f, 1.2f, 1.1f
};
const ChampionAttributes CHAMPION_5_ATTR = { // 奥拉夫（一星）
    Champion5, "奥拉夫", "../Resources/Champions/Champion5.png", 1, 1, 250, 0, 20, 200, 1, 0.8f, 1.2f, 0.8f
};
const ChampionAttributes CHAMPION_6_ATTR = { // 奥拉夫（二星）
    Champion6, "奥拉夫", "../Resources/Champions/Champion6.png", 3, 2, 300, 0, 25, 200, 1, 0.7f, 1.4f, 0.9f
};
const ChampionAttributes CHAMPION_7_ATTR = { // 潘森（一星）
    Champion7, "潘森", "../Resources/Champions/Champion7.png", 1, 1, 250, 0, 20, 200, 1, 1.0f, 1.0f, 1.1f
};
const ChampionAttributes CHAMPION_8_ATTR = { // 潘森（二星）
    Champion8, "潘森", "../Resources/Champions/Champion8.png", 3, 2, 300, 0, 25, 200, 1, 0.9f, 1.2f, 1.2f
};
...
const ChampionAttributes CHAMPION_11_ATTR = { // 库奇（一星）
    Champion11, "库奇", "../Resources/Champions/Champion11.png", 2, 1, 150, 0, 23, 200, 3, 0.7f, 1.1f, 0.7f
};
const ChampionAttributes CHAMPION_12_ATTR = { // 库奇（二星）
    Champion12, "库奇", "../Resources/Champions/Champion12.png", 6, 2, 200, 0, 28, 200, 3, 0.6f, 1.3f, 0.8f
};
...
const ChampionAttributes CHAMPION_15_ATTR = { // 亚索（一星）
    Champion15, "亚索", "../Resources/Champions/Champion15.png", 2, 1, 200, 0, 25, 200, 1, 0.7f, 1.0f, 1.0f
};
const ChampionAttributes CHAMPION_16_ATTR = { // 亚索（二星）
    Champion16, "亚索", "../Resources/Champions/Champion16.png", 6, 2, 250, 0, 30, 200, 1, 0.6f, 1.2f, 1.1f
};
...
const ChampionAttributes CHAMPION_19_ATTR = { // 塔姆（一星）
    Champion19, "塔姆", "../Resources/Champions/Champion19.png", 3, 1, 300, 0, 15, 200, 1, 1.0f, 1.0f, 1.2f
};
const ChampionAttributes CHAMPION_20_ATTR = { // 塔姆（二星）
    Champion20, "塔姆", "../Resources/Champions/Champion20.png", 9, 2, 350, 0, 20, 200, 1, 0.9f, 1.2f, 1.3f
};
...
const ChampionAttributes CHAMPION_25_ATTR = { // 奎桑提（一星）
    Champion25, "奎桑提", "../Resources/Champions/Champion25.png", 4, 1, 300, 0, 30, 200, 1, 0.7f, 1.0f, 1.1f
};
const ChampionAttributes CHAMPION_26_ATTR = { // 奎桑提（二星）
    Champion26, "奎桑提", "../Resources/Champions/Champion26.png", 12, 2, 350, 0, 35, 200, 1, 0.6f, 1.2f, 1.2f
};
