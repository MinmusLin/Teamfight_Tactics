...
constexpr int REFERENCE_SCENE_RETURN_MENU_BUTTON_OFFSET_X = 522;            // 玩法场景返回菜单按钮位置 X 偏移量
constexpr int REFERENCE_SCENE_RETURN_MENU_BUTTON_OFFSET_Y = -294;           // 玩法场景返回菜单按钮位置 Y 偏移量
