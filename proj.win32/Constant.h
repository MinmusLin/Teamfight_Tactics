...
constexpr char BATTLE_MAP_IDENTIFIER[] = "BattleMap_";                      // 玩家战斗区地图标识符
constexpr char BATTLE_MAP_FORMAT[] = "BattleMap_=%s";                       // 玩家战斗区地图格式字符串
...
constexpr int MENU_SCENE_EXIT_GAME_BUTTON_OFFSET = 55;                      // 菜单场景退出游戏按钮位置 X 偏移量
